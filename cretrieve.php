...
<?php require_once 'header.php';?>
 <?php
	  ...
	  $sql2="SELECT * FROM `order` where ostatus='2'";
	  $ret2=mysql_query($sql2,$conn);
	  $row2=mysql_fetch_array($ret2);
	  $n1=mysql_num_rows($ret2);
	  if($n1>0)
	  {
	  echo"<center><table id='style' border='4' cellpadding='15' cellspacing='5'>";
	  ...
	  do
	  {
		   ...
		   do{
			   ...
			   ?>
		          <td><a href='delporder.php?data=<?php echo $oid;?>&data1=<?php echo $mid;?>' target="bottomframe">Delete</a></tr>
		       <?php
	...
	{
	    echo "<br><br><center><strong><h2 style='font-style:oblique; color:red'>There is No  Cancelled Orders Yet!!!!";
	}
?>
</body>
</html>
