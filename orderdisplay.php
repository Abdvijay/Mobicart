...
<link rel="stylesheet" href="orderdisplay.css" />
</head>
...
<caption><b><h3>ORDERED PRODUCTS</h3></b></caption>
 <?php
	  ...
	  if(isset($_SESSION[uid]))
      {
	     ...
	     if($n1>0)
	     {
	        echo"<center><table id='order' border='4' cellpadding='15' cellspacing='5'>";
	        echo"<tr><TH>MOBILE BRAND<TH>MOBILE NAME<TH>MOBILE COLOR<TH>MOBILE RAM<TH>MOBILE ROM<TH>MOBILE PRICE<TH>QUANTITY<TH>AMOUNT<TH>DOOR NO<TH>STREET<TH>PLACE<TH>DISTRICT<TH>PINCODE<TH>LANDMARK<TH>PAYMENT<TH>ACTION</tr>";
	        do
	        {
	           $dno=$row2[dno];
	           $street=$row2[street];
		       ...
		       do{
		          ...
		          echo "<tr><td>$mobbrand<td>$mobname<td>$mobcolor<td>$mobram<td>$mobrom<td>$mobprice<td>$quantity<td>$amount<td>$dno<td>$street<td>$place<td>$district<td>$pincode<td>$landmark<td>$payment";
			      ?>
		             <td><a href='deleteorder.php?data=<?php echo $oid;?>&data1=<?php echo $mid;?>' target="bottomframe">DELETE</a></tr>
		          <?php
	     ...
	     mysql_close($conn);
		 ?>
		 <br /><center><b><a href="checkorder.php" target="bottomframe">PLACE YOUR ORDER</a></b></center>
		 <?php
       }
       else
	   {
